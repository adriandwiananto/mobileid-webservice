...
$caridocstatus = 0;
$doclist = carilegal($id_number,$caridocstatus);
...
<div class="container">
    <div class="row">
        ...
        <div class="col-sm-9 col-md-9">
            <span class="label label-primary">Daftar tunggu verifikasi</span>
				...
				<tbody>                                    
                    ...
                    foreach ($doclist as $doc) {
                        ...
                        //buat warna baris
                            ...
                            //akhir tabel
                            echo '<td><button type="button" onclick="deleteentry('.$id.');">Hapus</button> </td>';
                            echo "</tr>";
                            $index++;
                    }
                    ?>									
